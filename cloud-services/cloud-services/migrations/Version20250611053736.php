 ...
 */
final class Version20250611053736 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE patient_user DROP id, CHANGE patient_id patient_id INT AUTO_INCREMENT NOT NULL, CHANGE roles roles JSON NOT NULL, CHANGE created_at created_at DATETIME NOT NULL, CHANGE is_active is_active TINYINT(1) DEFAULT 1 NOT NULL, CHANGE reset_token reset_tok_fen VARCHAR(255) DEFAULT NULL
        SQL);
        $this->addSql(<<<'SQL'
