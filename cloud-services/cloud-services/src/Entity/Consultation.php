...
class Consultation
{
    ...
    public function getCurrentMedicationIds(): ?string { return $this->currentMedicationIds; }
    public function setCurrentMedicationIds(?string $currentMedicationIds): self {
        $this->currentMedicationIds = $currentMedicationIds;
        return $this;
    }

    public function getMedicalHistoryIds(): ?string { return $this->medicalHistoryIds; }
    public function setMedicalHistoryIds(?string $medicalHistoryIds): self {
        $this->medicalHistoryIds = $medicalHistoryIds;
        return $this;
    }

    public function getFamilyHistory(): ?string { return $this->familyHistory; }
    public function setFamilyHistory(?string $familyHistory): self {
        $this->familyHistory = $familyHistory;
        return $this;
    }

    public function getPulse(): ?float { return $this->pulse; }
    public function setPulse(?float $pulse): self {
        $this->pulse = $pulse;
        return $this;
    }

    public function getBloodPressure(): ?string { return $this->bloodPressure; }
    ...
    public function getHeightCm(): ?float { return $this->heightCm; }
    public function setHeightCm(?float $heightCm): self {
        $this->heightCm = $heightCm;
        return $this;
    }

    public function getRespiratoryRate(): ?int { return $this->respiratoryRate; }
    ...
    public function getDiagnosisIds(): ?string { return $this->diagnosisIds; }
    public function setDiagnosisIds(?string $diagnosisIds): self {
        $this->diagnosisIds = $diagnosisIds;
        return $this;
    }

    public function getReferralIds(): ?string { return $this->referralIds; }
    public function setReferralIds(?string $referralIds): self {
        $this->referralIds = $referralIds;
        return $this;
    }

    public function getPrescriptionIds(): ?string { return $this->prescriptionIds; }
